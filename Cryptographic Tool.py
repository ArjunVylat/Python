...
Entry(textvariable=code,bd=4,font='impack 20',show='*').place(x=110,y=220,width=200)
...
Button(screen,text='RESET',font='arial 15 bold',bg='blue',fg='white',command=reset).place(x=70,y=350,width=280)
